...
labs_plot <- c("<= 2 g/lt.", "2-4 g/lt.", "4-6 g/lt.", "> 6 g/lt.")
...
labs_plot_yield <- c("<= 3 t/ha", "3-6 t/ha", "6-9 t/ha", "> 9 t/ha")
```
...
```{r spatialmap2, out.width = '200%', fig.align = "center", fig.cap= "The spatial distribution of paddy spring yield and salinity level in February in MKD for the period 2000-2020", echo = F}
...
data_biscale <- bi_class(data_full_2, x = Salinity_in_Feb, y = Y_PDX_range, style = "equal", dim = 4) 
...
year <- array(data = unlist(years))

#all_plots2 = map(year, function(mapmkd) {
#     map(
#          mkd_map(year)
#     )
#})
...
ggdraw() +
  draw_plot(cowplot::plot_grid(mkd_2000, mkd_2001, mkd_2002, mkd_2003, mkd_2004, 
                               ...
                               mkd_2020, ncol=6)) +
  draw_plot(legend, 0.8, 0.005, 0.2, 0.2) +
  theme(plot.margin=unit(c(0,0,0,0), 'cm'))
```
